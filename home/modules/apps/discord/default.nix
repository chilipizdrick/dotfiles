{pkgs, ...}: rec {
  ...
  #       --background-image: url(file:///home/alex/.config/vesktop/themes/transparent.png); /* app background image (link must be HTTPS) [default: url(https://clearvision.github.io/images/sapphire.jpg)]*/
