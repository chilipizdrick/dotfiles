{self, ...} @ inputs: let
  nixosModule = {
    ...
    environment.systemPackages = with pkgs; [(btop.override {cudaSupport = true;})];
    ...
    home-manager.users.alex = {
      ...
      home.packages = with pkgs; [hyperhdr];
    };
  };
in {
  nixosConfigurations.aurora = self.lib.nixosSystem {inherit inputs;} [nixosModule];
}
